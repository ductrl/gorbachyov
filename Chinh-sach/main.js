...
Webflow.require("ix").init([
  {
    ...
    name: "Fade up and in",
    value: {
      style: { opacity: 0, x: "0px", y: "71px", z: "0px" },
      triggers: [
        {
          type: "scroll",
          offsetBot: "20%",
          stepsA: [
            {
              ...
              opacity: 1,
              transition:
                "transform 800ms ease-out 0ms, opacity 500ms ease 0ms",
              x: "0px",
              y: "0px",
              z: "0px",
            },
      ...
      triggers: [
        {
          type: "scroll",
          offsetBot: "10%",
          stepsA: [{ opacity: 1, transition: "opacity 800ms ease-out 0ms" }],
          stepsB: [],
        },
      ],
    },
      ...
      triggers: [
        {
          ...
          offsetBot: "50%",
          stepsA: [
            { wait: 2000, opacity: 1, transition: "opacity 500ms ease 0ms" },
          ],
          stepsB: [
            {
              wait: 2000,
  ...
  },
  {
    ...
    name: "Did you know",
    value: {
      style: { opacity: 0, x: "0px", y: "-12px", z: "0px" },
      triggers: [
        {
          type: "hover",
          stepsA: [{ opacity: 1, transition: "opacity 500ms ease 0ms" }],
  ...
  events: {
    e: {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "653f158016fc05c43c57a9ac|94d4598d-ff66-a2b7-8a0a-152ec4d64da5",
      },
      targets: [],
      config: {
        loop: false,
