...
(() => {
    ...
    "node_modules/core-js/internals/is-symbol.js"(exports, module) {
      ...
      module.exports = USE_SYMBOL_AS_UID
        ...
        : function (it) {
            ...
            return (
              isCallable($Symbol) &&
              isPrototypeOf($Symbol.prototype, Object2(it))
            );
          };
    },
  });
  ...
  var require_native_weak_map = __commonJS({
    "node_modules/core-js/internals/native-weak-map.js"(exports, module) {
      ...
      module.exports =
        isCallable(WeakMap2) && /native code/.test(inspectSource(WeakMap2));
    },
  });
  ...
  var require_export = __commonJS({
    "node_modules/core-js/internals/export.js"(exports, module) {
      ...
      var getOwnPropertyDescriptor =
        require_object_get_own_property_descriptor().f;
      var createNonEnumerableProperty =
        require_create_non_enumerable_property();
  ...
  var require_IX2EngineConstants = __commonJS({
    "packages/systems/ix2/shared/constants/IX2EngineConstants.js"(exports) {
      ...
      exports.W_MOD_JS =
        ...
        exports.HEIGHT =
        exports.FONT_VARIATION_SETTINGS =
        exports.FLEX =
        exports.FILTER =
        exports.DISPLAY =
  ...
  var require_IX2DataReducer = __commonJS({
    "packages/systems/ix2/engine/reducers/IX2DataReducer.js"(exports) {
      ...
      var { IX2_RAW_DATA_IMPORTED } = _constants.IX2EngineActionTypes;
      ...
      var ixSession = (state = initialState, action) => {
        switch (action.type) {
          ...
          case IX2_EVENT_LISTENER_ADDED: {
            const eventListeners = (0, _timm.addLast)(
  ...
  var require_IX2Spline = __commonJS({
    "packages/systems/ix2/plugins/IX2Spline.js"(exports) {
      ...
      var createPluginInstance = (element, actionItem) => {
        ...
        const pluginElementId =
          actionItem === null || actionItem === void 0
            ? void 0
            : (_actionItem$config = actionItem.config) === null ||
              _actionItem$config === void 0
            ? void 0
            : (_actionItem$config$ta = _actionItem$config.target) === null ||
              _actionItem$config$ta === void 0
            ? void 0
            : _actionItem$config$ta.pluginElement;
  ...
  var require_IX2Variable = __commonJS({
    "packages/systems/ix2/plugins/IX2Variable.js"(exports) {
      ...
      var renderPlugin = (_, refState, actionItem) => {
        ...
        const { PLUGIN_VARIABLE: props } = refState;
        const { size, red, green, blue, alpha } = props;
        let value;
        if (size != null) {
          value = size + unit;
        }
  ...
  var require_IX2VanillaUtils = __commonJS({
    "packages/systems/ix2/shared/logic/IX2VanillaUtils.js"(exports) {
      ...
      function reifyState({ events, actionLists, site } = {}) {
        const eventTypeMap = (0, _reduce.default)(
          events,
          (result, event) => {
      ...
      var getFontVariationDefaults = (actionState, fontVariations) =>
      ...
      var getItemConfigByKey = (actionTypeId, key, config) => {
        ...
        switch (actionTypeId) {
          case STYLE_FILTER: {
            const filter = (0, _findLast.default)(
              config.filters,
              ({ type }) => type === key
            );
          ...
          case STYLE_FONT_VARIATION: {
            const fontVariation = (0, _findLast.default)(
      ...
      function getDestinationValues({ element, actionItem, elementApi }) {
        if ((0, _IX2VanillaPlugins.isPluginType)(actionItem.actionTypeId)) {
          return (0, _IX2VanillaPlugins.getPluginDestination)(
      ...
      function renderFilter(
        ...
        const filterValue = (0, _reduce.default)(
          actionState,
          (result, value, type) =>
            `${result} ${type}(${value}${getFilterUnit(
              type,
              actionItemConfig
            )})`,
          ""
      ...
      function renderFontVariation(
        ...
        const fontVariationValue = (0, _reduce.default)(
          actionState,
          (result, value, type) => {
      ...
      function hasDefined3dTransform(
        ...
        return (
          (actionTypeId === TRANSFORM_MOVE && zValue !== void 0) || // SCALE_Z
      ...
      function parseColor({ element, actionTypeId, computedStyle, getStyle }) {
        ...
        const value = rgbValidRegex.test(inlineValue)
          ? inlineValue
          : computedStyle[prop];
        const matches = getFirstMatch(rgbMatchRegex, value).split(
          COMMA_DELIMITER
        );
        return {
      ...
      function clearActionGroupStyles({ actionGroup, event, elementApi }) {
        ...
        actionItems.forEach((actionItem) => {
          ...
          if ((0, _IX2VanillaPlugins.isPluginType)(actionTypeId)) {
            clearElement = (ref) =>
              (0, _IX2VanillaPlugins.clearPlugin)(actionTypeId)(
                ref,
                actionItem
              );
          } else {
    ...
    "packages/systems/ix2/shared/index.js"(exports) {
      ...
      exports.IX2VanillaUtils =
        ...
        exports.IX2BrowserSupport =
          void 0;
      var IX2BrowserSupport = _interopRequireWildcard(
        require_IX2BrowserSupport()
      );
      ...
      var IX2VanillaPlugins = _interopRequireWildcard(
  ...
  var require_IX2InstancesReducer = __commonJS({
    "packages/systems/ix2/engine/reducers/IX2InstancesReducer.js"(exports) {
      ...
      var { optimizeFloat, applyEasing, createBezierEasing } =
        _shared.IX2EasingUtils;
      var { RENDER_GENERAL } = _constants.IX2EngineConstants;
      var { getItemConfigByKey, getRenderType, getStyleProp } =
      ...
      var continuousInstance = (state, action) => {
        ...
        if (fromActionItem && !toActionItem) {
          ...
          for (let i = 0, { length } = destinationKeys; i < length; i++) {
            ...
            const toVal = getItemConfigByKey(
              actionTypeId,
              key,
              toActionItem.config
            );
  ...
  var require_IX2BrowserApi = __commonJS({
    "packages/systems/ix2/engine/logic/IX2BrowserApi.js"(exports) {
      ...
      var { IX2_ID_DELIMITER, HTML_ELEMENT, PLAIN_OBJECT, WF_PAGE } =
        _constants.IX2EngineConstants;
  ...
  var require_IX2VanillaEvents = __commonJS({
    "packages/systems/ix2/engine/logic/IX2VanillaEvents.js"(exports) {
      ...
      var pointIntersects = (point, rect) =>
      ...
      var getComponentActiveOptions = (allowNestedChildrenEvents = true) =>
        (0, _extends2.default)({}, baseActivityActionGroupOptions, {
          handler: withFilter(
      ...
      var _default = {
        ...
        [PAGE_SCROLL_DOWN]: (0, _extends2.default)(
          {},
          baseScrollActionGroupOptions,
          {
        ...
        [PAGE_SCROLL_UP]: (0, _extends2.default)(
          {},
          baseScrollActionGroupOptions,
          {
            handler: whenScrollDirectionChange((options, state) => {
  ...
  var require_IX2VanillaEngine = __commonJS({
    "packages/systems/ix2/engine/logic/IX2VanillaEngine.js"(exports) {
      ...
      var { isPluginType, createPluginInstance, getPluginDuration } =
      ...
      function createGroupInstances({
        ...
        continuousActionGroups.forEach((actionGroup) => {
          ...
          actionItems.forEach((actionItem) => {
            ...
            const key =
              stringifyTarget(target) + COLON_DELIMITER + actionTypeId;
        ...
        instanceConfigs.forEach(({ element, key }) => {
          ...
          const actionItem = (0, _get.default)(
            actionGroups,
            `[0].actionItems[0]`,
            {}
          );
      ...
      var mapFoundValues = (object, iteratee) =>
        (0, _omitBy.default)(
      ...
      function bindEventType({ logic, store, events }) {
        ...
        (0, _forEach.default)(eventTargets, (elements, key) => {
          ...
          if (
            ...
            configs.forEach((eventConfig) => {
              ...
              const parameterGroup = (0, _find.default)(
                paramGroups,
        ...
        const handleEventThrottled = (0, _throttle.default)(
          handleEvent,
      ...
      function renderInitialGroup({ store, actionListId, eventId }) {
        ...
        if (actionList && actionList.useFirstGroupAsInitialState) {
          const initialStateItems = (0, _get.default)(
            actionList,
            "actionItemGroups[0].actionItems",
            []
          );
          const mediaQueries = (0, _get.default)(
            event,
            "mediaQueries",
          ...
          initialStateItems.forEach((actionItem) => {
            ...
            const config =
              ...
              (itemConfig === null || itemConfig === void 0
                ? void 0
                : (_itemConfig$target2 = itemConfig.target) === null ||
                  _itemConfig$target2 === void 0
                ? void 0
                : _itemConfig$target2.objectId) == null
                ? {
                    target: event.target,
                    targets: event.targets,
                  }
      ...
      function startActionGroup({
        ...
        const actionList = (0, _get.default)(
          ixData,
        ...
        const instanceDelay =
          ...
          isQuickEffect(
            ...
            ? event.config.delay
            : void 0;
        const actionItems = (0, _get.default)(
          actionItemGroups,
        ...
        actionItems.forEach((actionItem, actionIndex) => {
          ...
          elements.forEach((element, elementIndex) => {
            ...
            const isCarrier =
              carrierIndex === actionIndex && elementIndex === 0;
      ...
      function createInstance(options) {
        ...
        const { store, computedStyle } = options,
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "653d3f46acd2104c5fe949f7|2d7e26bb-4fe0-2ada-f3ef-43363f4a86c3",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-9": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "653d3f46acd2104c5fe949f7|3fb65078-c6a0-2936-5818-31923010ec43",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-10": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "653d3f46acd2104c5fe949f7|d36b0767-9574-62ce-1ba8-20aa097c1217",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-11": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "653d3f46acd2104c5fe949f7|7caf6718-762b-0211-9095-1ab2acaccd46",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-12": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "653d3f46acd2104c5fe949f7|7caf6d63-5538-f474-c297-1c9d3c072350",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-13": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "653e871243889296cd96f334|ebac61d1-8f70-386d-d893-20cf0a9362ea",
      },
      targets: [],
      config: {
        loop: false,
    ...
    "e-15": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "653e871243889296cd96f334|ae6add3e-8f3d-9ffd-d149-7c69a648be8b",
      },
      targets: [],
      config: {
        loop: false,
    ...
    "e-17": {
      ...
      target: {
        ...
        originalId:
          "653e871243889296cd96f334|4a2648e7-4fa1-ab1f-2598-69177f822c93",
        appliesTo: "CLASS",
      },
      targets: [],
      config: {
      ...
      createdOn: 1698600651991,
    },
  },
  actionLists: {
    a: {
      id: "a",
      title: "timeline-stage-animation",
      continuousParameterGroups: [
        {
          id: "a-p",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selector: ".stage-tag",
                      selectorGuids: ["cbca2097-788f-3655-6c85-b9ba8e2270fb"],
                    },
                    globalSwatchId: "",
                    rValue: 192,
                    bValue: 14,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".heading-60px",
                      selectorGuids: ["1442a494-a73a-7483-dc89-8bcbf989d34d"],
                    },
                    globalSwatchId: "",
                    rValue: 192,
                    bValue: 14,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".timeline-circle",
                      selectorGuids: ["f2a1aac4-2067-a926-2008-c18d289b19e6"],
                    },
                    globalSwatchId: "",
                    rValue: 92,
                    bValue: 33,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".heading-35px.right-title",
                      selectorGuids: [
                        "6c973a4e-3ee6-d6bd-98de-3d1498bf6fe3",
                        "d35ccb3d-004b-596f-1316-e83ce0476645",
                      ],
                    },
                    globalSwatchId: "",
                    rValue: 255,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".paragraph-20px.right-text",
                      selectorGuids: [
                        "04e08a35-db71-03bf-1aac-f1f29ba31891",
                        "1f94ff70-4fe0-6c7f-57b7-be5740a8ac49",
                      ],
                    },
                    globalSwatchId: "",
                    rValue: 255,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 400,
                target: {
                  id: "653d3f46acd2104c5fe949f7|59c07231-fecd-026c-c712-42ec0a172666",
                },
                yValue: 0,
                xUnit: "PX",
                yUnit: "vw",
    ...
    "a-4": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "653d3f46acd2104c5fe949f7|8e7bc882-3f1d-1fab-ae49-253b0031ffe7",
                },
                value: 1,
                unit: "",
              },
      ...
      createdOn: 1685113144501,
    },
    "a-5": {
      id: "a-5",
      title: "page-ends-loading",
      actionItemGroups: [
        {
          actionItems: [
            {
